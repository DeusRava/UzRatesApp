...
import { fetchRates, Rate, CURRENCY_FLAGS, MAIN_CURRENCIES, getCacheAge } from '../utils/api';
...
const styles = StyleSheet.create({
  ...
  cardFlag: { fontSize: 26, marginRight: 12 },
  ...
  cardRate: { color: COLORS.text, fontSize: 16, fontWeight: '700', letterSpacing: -0.3 },
  ...
  modalFlag: { fontSize: 52, marginBottom: 8 },
